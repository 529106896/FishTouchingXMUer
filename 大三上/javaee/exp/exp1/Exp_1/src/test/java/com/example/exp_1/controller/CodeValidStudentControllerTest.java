...
public class CodeValidStudentControllerTest {
    ...
    public void createStudentTest() throws Exception {
        ...
        String responseString = this.mvc.perform(post("/codevalid/student").contentType("application/json;charset=UTF-8").content(studentJson))
